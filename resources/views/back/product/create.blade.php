...
@section('content')
    ...
    <div class="container">
        ...
        @endif
            ...
            <div>
                @if (Route::is('product.edit'))
                    <button type="submit" class="btn btn-block create-account btn-lg">Modifier</button>
                @endif
                @if(Route::is('product.create'))
                    <button type="submit" class="btn btn-block create-account btn-lg">Ajouter</button>
                @endif
            </div>
        </form>
        <div class="m-xl-4">
